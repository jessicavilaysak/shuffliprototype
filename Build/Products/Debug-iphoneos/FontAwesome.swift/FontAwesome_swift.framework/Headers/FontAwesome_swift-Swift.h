...
SWIFT_MODULE_NAMESPACE_PUSH("FontAwesome_swift")
@class NSCoder;

/// A view for FontAwesome icons.
SWIFT_CLASS("_TtC17FontAwesome_swift15FontAwesomeView")
...
@interface UIFont (SWIFT_EXTENSION(FontAwesome_swift))
...
+ (UIFont * _Nonnull)fontAwesomeOfSize:(CGFloat)fontSize SWIFT_WARN_UNUSED_RESULT;
@end

@class UIColor;

@interface UIImage (SWIFT_EXTENSION(FontAwesome_swift))
...
+ (UIImage * _Nullable)fontAwesomeIconWithCode:(NSString * _Nonnull)code textColor:(UIColor * _Nonnull)textColor size:(CGSize)size backgroundColor:(UIColor * _Nonnull)backgroundColor SWIFT_WARN_UNUSED_RESULT;
@end
